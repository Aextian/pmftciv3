...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('shs_acads_cleared_students', function (Blueprint $table) {
    ...
    {
        Schema::table('shs_acads_cleared_students', function (Blueprint $table) {
            $table->dropForeign('shs_acads_cleared_students_acads_user_id_foreign');
            $table->dropForeign('shs_acads_cleared_students_sem_id_foreign');
            $table->dropForeign('shs_acads_cleared_students_std_id_foreign');
            $table->dropForeign('shs_acads_cleared_students_sy_id_foreign');
        });
    }
};
