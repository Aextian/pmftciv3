...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_student_payments', function (Blueprint $table) {
    ...
    {
        Schema::table('college_student_payments', function (Blueprint $table) {
            $table->dropForeign('college_student_payments_std_id_foreign');
            $table->dropForeign('college_student_payments_std_prog_id_foreign');
            $table->dropForeign('college_student_payments_user_id_foreign');
        });
    }
};
