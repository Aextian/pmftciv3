...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_ob_quizzes', function (Blueprint $table) {
    ...
    {
        Schema::table('college_ob_quizzes', function (Blueprint $table) {
            $table->dropForeign('college_ob_quizzes_grading_period_id_foreign');
            $table->dropForeign('college_ob_quizzes_lesson_id_foreign');
            $table->dropForeign('college_ob_quizzes_tpss_id_foreign');
        });
    }
};
