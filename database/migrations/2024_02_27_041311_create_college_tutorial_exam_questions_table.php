...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('college_tutorial_exam_questions', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('exam_id')->nullable()->index('college_tutorial_exam_questions_exam_id_foreign');
    ...
    {
        Schema::dropIfExists('college_tutorial_exam_questions');
    }
};
