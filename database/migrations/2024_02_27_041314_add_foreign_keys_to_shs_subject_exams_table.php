...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('shs_subject_exams', function (Blueprint $table) {
    ...
    {
        Schema::table('shs_subject_exams', function (Blueprint $table) {
            $table->dropForeign('shs_subject_exams_quarter_id_foreign');
            $table->dropForeign('shs_subject_exams_tpss_id_foreign');
        });
    }
};
