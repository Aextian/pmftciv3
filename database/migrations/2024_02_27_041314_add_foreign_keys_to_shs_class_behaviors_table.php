...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('shs_class_behaviors', function (Blueprint $table) {
    ...
    {
        Schema::table('shs_class_behaviors', function (Blueprint $table) {
            $table->dropForeign('shs_class_behaviors_lesson_id_foreign');
            $table->dropForeign('shs_class_behaviors_lesson_sched_id_foreign');
            $table->dropForeign('shs_class_behaviors_std_id_foreign');
            $table->dropForeign('shs_class_behaviors_teacher_id_foreign');
        });
    }
};
