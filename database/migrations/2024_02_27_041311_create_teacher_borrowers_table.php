...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('teacher_borrowers', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('item_id')->nullable()->index('teacher_borrowers_item_id_foreign');
            $table->unsignedBigInteger('user_id')->nullable()->index('teacher_borrowers_user_id_foreign');
    ...
    {
        Schema::dropIfExists('teacher_borrowers');
    }
};
