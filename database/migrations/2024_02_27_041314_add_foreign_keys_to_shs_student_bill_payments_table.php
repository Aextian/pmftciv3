...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('shs_student_bill_payments', function (Blueprint $table) {
    ...
    {
        Schema::table('shs_student_bill_payments', function (Blueprint $table) {
            $table->dropForeign('shs_student_bill_payments_encoder_id_foreign');
            $table->dropForeign('shs_student_bill_payments_std_id_foreign');
            $table->dropForeign('shs_student_bill_payments_std_program_id_foreign');
            $table->dropForeign('shs_student_bill_payments_sy_id_foreign');
            $table->dropForeign('shs_student_bill_payments_user_id_foreign');
        });
    }
};
