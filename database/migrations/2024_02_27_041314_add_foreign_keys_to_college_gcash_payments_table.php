...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_gcash_payments', function (Blueprint $table) {
    ...
    {
        Schema::table('college_gcash_payments', function (Blueprint $table) {
            $table->dropForeign('college_gcash_payments_approved_by_foreign');
            $table->dropForeign('college_gcash_payments_declined_by_foreign');
            $table->dropForeign('college_gcash_payments_sem_id_foreign');
            $table->dropForeign('college_gcash_payments_std_prog_id_foreign');
            $table->dropForeign('college_gcash_payments_sy_id_foreign');
            $table->dropForeign('college_gcash_payments_verify_by_foreign');
        });
    }
};
