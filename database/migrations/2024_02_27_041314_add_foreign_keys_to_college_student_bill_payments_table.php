...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_student_bill_payments', function (Blueprint $table) {
    ...
    {
        Schema::table('college_student_bill_payments', function (Blueprint $table) {
            $table->dropForeign('college_student_bill_payments_encoder_id_foreign');
            $table->dropForeign('college_student_bill_payments_sem_id_foreign');
            $table->dropForeign('college_student_bill_payments_std_id_foreign');
            $table->dropForeign('college_student_bill_payments_std_program_id_foreign');
            $table->dropForeign('college_student_bill_payments_sy_id_foreign');
            $table->dropForeign('college_student_bill_payments_user_id_foreign');
        });
    }
};
