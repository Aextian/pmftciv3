...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('shs_subject_exam_obes', function (Blueprint $table) {
    ...
    {
        Schema::table('shs_subject_exam_obes', function (Blueprint $table) {
            $table->dropForeign('shs_subject_exam_obes_quarter_id_foreign');
            $table->dropForeign('shs_subject_exam_obes_tpss_id_foreign');
        });
    }
};
