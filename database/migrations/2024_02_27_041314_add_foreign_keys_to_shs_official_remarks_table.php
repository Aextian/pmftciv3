...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('shs_official_remarks', function (Blueprint $table) {
    ...
    {
        Schema::table('shs_official_remarks', function (Blueprint $table) {
            $table->dropForeign('shs_official_remarks_official_user_id_foreign');
            $table->dropForeign('shs_official_remarks_sem_id_foreign');
            $table->dropForeign('shs_official_remarks_std_id_foreign');
            $table->dropForeign('shs_official_remarks_sy_id_foreign');
        });
    }
};
