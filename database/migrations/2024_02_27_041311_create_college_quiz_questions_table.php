...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('college_quiz_questions', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('quiz_id')->nullable()->index('college_quiz_questions_quiz_id_foreign');
    ...
    {
        Schema::dropIfExists('college_quiz_questions');
    }
};
