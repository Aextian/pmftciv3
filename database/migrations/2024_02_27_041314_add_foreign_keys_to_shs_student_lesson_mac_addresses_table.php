...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('shs_student_lesson_mac_addresses', function (Blueprint $table) {
    ...
    {
        Schema::table('shs_student_lesson_mac_addresses', function (Blueprint $table) {
            $table->dropForeign('shs_student_lesson_mac_addresses_lesson_id_foreign');
            $table->dropForeign('shs_student_lesson_mac_addresses_lesson_sched_id_foreign');
            $table->dropForeign('shs_student_lesson_mac_addresses_std_id_foreign');
        });
    }
};
