...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('college_student_exams', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('exam_id')->nullable()->index('college_student_exams_exam_id_foreign');
            $table->unsignedBigInteger('std_id')->nullable()->index('college_student_exams_std_id_foreign');
    ...
    {
        Schema::dropIfExists('college_student_exams');
    }
};
