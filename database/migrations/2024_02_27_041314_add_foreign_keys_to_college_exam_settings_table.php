...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_exam_settings', function (Blueprint $table) {
    ...
    {
        Schema::table('college_exam_settings', function (Blueprint $table) {
            $table->dropForeign('college_exam_settings_gp_id_foreign');
            $table->dropForeign('college_exam_settings_sem_id_foreign');
            $table->dropForeign('college_exam_settings_sy_id_foreign');
        });
    }
};
