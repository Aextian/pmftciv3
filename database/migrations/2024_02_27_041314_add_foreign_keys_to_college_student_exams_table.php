...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_student_exams', function (Blueprint $table) {
    ...
    {
        Schema::table('college_student_exams', function (Blueprint $table) {
            $table->dropForeign('college_student_exams_exam_id_foreign');
            $table->dropForeign('college_student_exams_std_id_foreign');
        });
    }
};
