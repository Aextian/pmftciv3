...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_curriculum_subjects', function (Blueprint $table) {
    ...
    {
        Schema::table('college_curriculum_subjects', function (Blueprint $table) {
            $table->dropForeign('college_curriculum_subjects_curr_id_foreign');
            $table->dropForeign('college_curriculum_subjects_curr_program_id_foreign');
            $table->dropForeign('college_curriculum_subjects_program_id_foreign');
            $table->dropForeign('college_curriculum_subjects_sem_id_foreign');
            $table->dropForeign('college_curriculum_subjects_subject_id_foreign');
            $table->dropForeign('college_curriculum_subjects_yr_lvl_id_foreign');
        });
    }
};
