...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_tasks', function (Blueprint $table) {
    ...
    {
        Schema::table('college_tasks', function (Blueprint $table) {
            $table->dropForeign('college_tasks_grading_period_id_foreign');
            $table->dropForeign('college_tasks_sem_id_foreign');
            $table->dropForeign('college_tasks_sy_id_foreign');
        });
    }
};
