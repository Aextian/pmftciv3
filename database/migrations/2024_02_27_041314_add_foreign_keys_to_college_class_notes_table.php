...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_class_notes', function (Blueprint $table) {
    ...
    {
        Schema::table('college_class_notes', function (Blueprint $table) {
            $table->dropForeign('college_class_notes_lesson_id_foreign');
            $table->dropForeign('college_class_notes_lesson_sched_id_foreign');
            $table->dropForeign('college_class_notes_std_id_foreign');
            $table->dropForeign('college_class_notes_teacher_id_foreign');
        });
    }
};
