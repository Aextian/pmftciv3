...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_student_subjects', function (Blueprint $table) {
    ...
    {
        Schema::table('college_student_subjects', function (Blueprint $table) {
            $table->dropForeign('college_student_subjects_curr_id_foreign');
            $table->dropForeign('college_student_subjects_curr_program_id_foreign');
            $table->dropForeign('college_student_subjects_offered_subject_id_foreign');
            $table->dropForeign('college_student_subjects_program_id_foreign');
            $table->dropForeign('college_student_subjects_section_id_foreign');
            $table->dropForeign('college_student_subjects_sem_id_foreign');
            $table->dropForeign('college_student_subjects_std_id_foreign');
            $table->dropForeign('college_student_subjects_std_program_id_foreign');
            $table->dropForeign('college_student_subjects_subject_id_foreign');
            $table->dropForeign('college_student_subjects_sy_id_foreign');
            $table->dropForeign('college_student_subjects_user_id_foreign');
            $table->dropForeign('college_student_subjects_yrlvl_id_foreign');
        });
    }
};
