...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_class_recitations', function (Blueprint $table) {
    ...
    {
        Schema::table('college_class_recitations', function (Blueprint $table) {
            $table->dropForeign('college_class_recitations_lesson_id_foreign');
            $table->dropForeign('college_class_recitations_lesson_sched_id_foreign');
            $table->dropForeign('college_class_recitations_std_id_foreign');
            $table->dropForeign('college_class_recitations_teacher_id_foreign');
        });
    }
};
