...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('shs_class_recitations', function (Blueprint $table) {
    ...
    {
        Schema::table('shs_class_recitations', function (Blueprint $table) {
            $table->dropForeign('shs_class_recitations_lesson_id_foreign');
            $table->dropForeign('shs_class_recitations_lesson_sched_id_foreign');
            $table->dropForeign('shs_class_recitations_std_id_foreign');
            $table->dropForeign('shs_class_recitations_teacher_id_foreign');
        });
    }
};
