...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('shs_class_attendances', function (Blueprint $table) {
    ...
    {
        Schema::table('shs_class_attendances', function (Blueprint $table) {
            $table->dropForeign('shs_class_attendances_lesson_id_foreign');
            $table->dropForeign('shs_class_attendances_lesson_sched_id_foreign');
            $table->dropForeign('shs_class_attendances_std_id_foreign');
            $table->dropForeign('shs_class_attendances_teacher_id_foreign');
        });
    }
};
