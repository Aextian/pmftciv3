...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('shs_tasks', function (Blueprint $table) {
    ...
    {
        Schema::table('shs_tasks', function (Blueprint $table) {
            $table->dropForeign('shs_tasks_quarter_id_foreign');
            $table->dropForeign('shs_tasks_sem_id_foreign');
            $table->dropForeign('shs_tasks_sy_id_foreign');
        });
    }
};
