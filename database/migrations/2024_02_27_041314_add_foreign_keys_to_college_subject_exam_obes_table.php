...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_subject_exam_obes', function (Blueprint $table) {
    ...
    {
        Schema::table('college_subject_exam_obes', function (Blueprint $table) {
            $table->dropForeign('college_subject_exam_obes_grading_period_id_foreign');
            $table->dropForeign('college_subject_exam_obes_tpss_id_foreign');
        });
    }
};
