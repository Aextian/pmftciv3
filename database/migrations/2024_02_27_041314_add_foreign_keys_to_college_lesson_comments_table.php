...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_lesson_comments', function (Blueprint $table) {
    ...
    {
        Schema::table('college_lesson_comments', function (Blueprint $table) {
            $table->dropForeign('college_lesson_comments_lesson_id_foreign');
            $table->dropForeign('college_lesson_comments_s_user_id_foreign');
            $table->dropForeign('college_lesson_comments_t_user_id_foreign');
        });
    }
};
