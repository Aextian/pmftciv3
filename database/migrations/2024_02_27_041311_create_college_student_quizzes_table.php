...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('college_student_quizzes', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('quiz_id')->nullable()->index('college_student_quizzes_quiz_id_foreign');
            $table->unsignedBigInteger('std_id')->nullable()->index('college_student_quizzes_std_id_foreign');
    ...
    {
        Schema::dropIfExists('college_student_quizzes');
    }
};
