...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('college_borrowers', function (Blueprint $table) {
    ...
    {
        Schema::table('college_borrowers', function (Blueprint $table) {
            $table->dropForeign('college_borrowers_item_id_foreign');
            $table->dropForeign('college_borrowers_std_prog_id_foreign');
            $table->dropForeign('college_borrowers_user_id_foreign');
        });
    }
};
